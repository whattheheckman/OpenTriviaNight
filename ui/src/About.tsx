  ...
  return (
    <div className="flex flex-col gap-4 mt-4 mb-16">
      ...
      <ol className="list-decimal list-inside space-y-3">
        <li>
          When the game begins, the Host picks a player who gets to pick the first question.
        </li>
        <li>
          The chosen player picks one of the cards shown.
          The cards are grouped by Category, and only the points value of each question is shown.
        </li>
        <li>
          Once a question has been picked, the Host will read it out.
          When the Host has completed reading the question, your Answer button will be unlocked, allowing you to buzz in.
      ...
      <p>
        The Host is the player who creates the game, and chooses what questions will be in the game.
      </p>

      <h3 className="text-lg font-semibold mt-2">Creating the Game</h3>
      <p>A game consists of the number of rounds (1 minimum). Each round will contain a number of categories (4-5 recomended), and each category will contain a number of questions (5 recomended).</p>
      <p>Questions are made up of the question text, the correct answer, and the points value. It is recomended for the points value to increase for each question in the category.</p>
      {/* TODO: Add images showing example question sets */}
      <p>You have the option of either creating questions/categories manually, or using one of our integrated question sources (<a className="hover:underline text-sky-400" href="https://opentdb.com" target="_blank" rel="noopener noreferrer">Open Trivia Database</a> or <a className="hover:underline text-sky-400" href="https://the-trivia-api.com" target="_blank" rel="noopener noreferrer">The Trivia API</a>) to generate questions for you.</p>
      <p>Once you have a suitable set of questions for your game, you can proceed to create the game and invite players by sharing the generated Game ID with them.</p>

      <h3 className="text-lg font-semibold mt-2">Hosting the Game</h3>
      <p>Hosting the game consists of 3 simple tasks:</p>
      <ol className="list-decimal list-inside space-y-3">
        <li>
          Selecting and reading out questions picked by the last Contestant to win points. When the game starts, the first question chooser is picked by you.
        </li>
        <li>
          When you have read out the selected question, you should "release" the buzzers (by clicking the 'Finished Reading' button) to allow Contestants to buzz in their answer. This is done to prevent Contestests buzzing in early.
        </li>
        <li>
          Only a single Contestant is allowed to buzz in at a time. When one has buzzed in, they should provide their answer to you. You will then decide if it is correct or not.
        </li>
      </ol>
