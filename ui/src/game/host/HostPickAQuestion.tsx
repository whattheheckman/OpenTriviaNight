          ...
          return <div className="flex flex-col min-w-48 grow flex-1 mx-2 gap-4">
            ...
            {questions.map(q => {
              return q.answered
                ...
                : <Button key={q.questionId} className="flex items-center justify-center bg-orange-400 hover:bg-orange-500 text-white rounded-lg h-16" color="none" onClick={() => pickQuestion(q.questionId)}>
